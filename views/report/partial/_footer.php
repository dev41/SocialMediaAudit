        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3 col-xs-6">
                    ...
                    <ul class="list--hover footer-recent-updates">
                        <li>
                            <div class="col-xs-2">
                                <i class="socicon socicon-twitter icon icon--xs"></i>
                            </div>
                            <div class="col-xs-10">Beginning documentation on our latest template. Looking forward to releasing on
                                <a href="#">@ThemeForest</a> soon! <a href="#">http://mmra.re/12</a>
                            </div>
                        </li>
                        <li>
                            <div class="col-xs-2">
